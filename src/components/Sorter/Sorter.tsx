...
export const Sorter = () => {
    ...
    return <div className="sorter">
        <Button text="A-Z"
                type="button"
                className="sort sorting-a-z"
                func={() => handleSortingClick("taskContent")}
        />
        <Button text="Category"
                type="button"
                className="sort sorting-category"
                func={() => handleSortingClick("category")}
        />
        <Button text="Priority"
                type="button"
                className="sort sorting-priority"
                func={() => handleSortingClick("priority")}
        />
        <Button text="Due Date"
                type="button"
                className="sort sorting-dueDate"
